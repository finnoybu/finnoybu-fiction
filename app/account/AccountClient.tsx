...
export default function AccountClient({ totalChapters }: AccountClientProps) {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            ...
            <div className="p-5 bg-bg-elev border border-rule-soft rounded-lg">
              ...
              <p className="font-display text-xl text-ink" style={{ fontFeatureSettings: "'ss01'" }}>
                {stats.hasPurchase ? 'Purchased' : 'Coming soon'}
              </p>
              {stats.hasPurchase ? (
                ...
                <span
                  aria-disabled="true"
                  className="mt-2 inline-block font-sans text-xs text-ink-faint line-through cursor-not-allowed"
                >
                  Buy for $7.49
                </span>
              )}
